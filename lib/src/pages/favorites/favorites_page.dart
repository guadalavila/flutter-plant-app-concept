...
import 'package:flutter_plant_app/src/widgets/favorite/empty_favs.dart';
...
class FavoritePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: _favoritesProvider.favorites.length != 0
          ? CustomScrollView(
              slivers: [
                            ...
                            child: Row(children: [
                              ...
                              Container(
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    _favoritesProvider.removeFav(
                                        _favoritesProvider.favorites[i]);
                                  },
                                ),
                              )
                            ]))))),
